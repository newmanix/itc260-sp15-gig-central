...
<html lang="en">
  ...
  <body>
     <div class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a href="<?=base_url()?>index.php"> <img style="float:left; width:100px; height:50px;" alt="Logo" src="<?=base_url()?>public/img/Gig-logo.png">	</a>
     ...
     <li ><a href="http://mahitletdan.com/itc260/gig-ci/index.php/Startup_form/example" title="">Example</a></li>
  <li ><a href="http://mahitletdan.com/itc260/gig-ci/index.php/Startup_form/index" title="">Start up Form</a></li>
